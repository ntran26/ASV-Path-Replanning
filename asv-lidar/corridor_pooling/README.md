# Corridor pooling branch

Pooling mode: `corridor`
...
```bash
python train_test_asv.py   --mode train   --algo sac   --timesteps 1000000   --num-envs 8   --seed 675973   --eval-freq 50000   --save-freq 100000   --model-path sac_corridor_pooling.zip
```
...
```bash
python evaluate_sac_suite.py   --model-path sac_corridor_pooling.zip   --suite-json data/env_setup/eval_suite/asv_eval_suite.json   --out-dir eval_results/corridor_pooling
```
