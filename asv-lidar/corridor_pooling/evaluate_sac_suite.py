...
# User settings
# -----------------------------
MODEL_PATH = "best_model_750000.zip"
SUITE_JSON = "eval_suite/asv_success_suite.json"
...
def parse_args():
    ...
    ap.add_argument("--suite-json", default=SUITE_JSON)
    ap.add_argument("--out-dir", default=OUT_DIR)
    ap.add_argument("--limit-scenarios", type=int, default=LIMIT_SCENARIOS)
