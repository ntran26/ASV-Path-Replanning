...
Test case 1: centered straight path, single obstacle on path
Test case 2: centered straight path, single obstacle left of path
Test case 3: centered straight path, single obstacle right of path
...
Paper-replica cases:
Test case 8:  Scenario B style, smooth S-bend path, no obstacles
Test case 9:  Scenario B style, smooth right bend path, no obstacles
Test case 10: Scenario C style, straight path with two close on-path obstacles
Test case 11: Scenario C style, straight path with near-path offset obstacles
Test case 12: Scenario C style, narrow gate centered on path
Test case 13: Scenario C/D style, S-bend path with one obstacle near the bend
Test case 14: close-pass single obstacle, early on path
Test case 15: close-pass single obstacle, late on path
Test case 16: controlled slalom, alternating obstacles along path
Test case 17: off-path obstacle left, should not cause a large detour
Test case 18: off-path obstacle right, should not cause a large detour
Test case 19: diagonal path, no obstacles, left-to-right
Test case 20: diagonal path, no obstacles, right-to-left
