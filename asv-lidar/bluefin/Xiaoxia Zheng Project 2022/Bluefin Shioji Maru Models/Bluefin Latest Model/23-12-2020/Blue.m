...
%  Hull parameters:
    ...
    Xvv = 174.014125320878e-003;    Yvv = 1.08140832998334e-003;       Nvv = 482.463882083071e-006;
    Xrr = 2.16961092325947e-009;    Yrr = -22.7583008858493e-012;      Nrr = -10.1534803187344e-012;
    Xvr = -269.790363655440e-006;   Yvr = 262.214901533461e-009;       Nvr = 116.985615725573e-009;
...
% Hull:
 ...
 XH = 1/2*rho*U^2*L*d*Sw/(L*d)*0.4631/(log(4*10^7)^2.6)*u^2+...
