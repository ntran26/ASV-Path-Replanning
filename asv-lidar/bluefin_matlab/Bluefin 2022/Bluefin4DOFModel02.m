...
% 
function xdot = Bluefin4DOFModel02(x,ui)
...
% conversion factor:
 ...
 %   cf = 0.5240; cf = LPB1/LPB2 where:
 % LPB = ratio of lenghth to breadth
     cf = 1;
...
% ratios of interaction coefficients (passenger ferry):
    ...
    gR      = gR0*(1+cg*abs(phi))*cf;
    ldR     = -0.795*cf;           % just from the Yoshimura (2017)
    epsi    =  0.740*cf;
    kappa   =  0.810*cf;
    eta     =  0.140*cf;
  % kx      =  0.140;
